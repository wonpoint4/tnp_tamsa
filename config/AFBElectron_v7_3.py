...
############## binning ################
bin_ID = [
    { 'var' : 'el_eta' , 'type': 'float', 'bins': [-2.5, -2.1, -1.80, -1.566, -1.4442, -1.1, -0.8, -0.4, 0.0, 0.4, 0.8, 1.1, 1.4442, 1.566, 1.80, 2.1, 2.5], 'title':'#eta' },
    { 'var' : 'el_pt' , 'type': 'float', 'bins': [10, 15, 20, 25, 30, 35, 40, 45, 70, 100, 500], 'title':'p_{T} [GeV]' },
]
bin_Ele35 = [
    { 'var' : 'el_eta' , 'type': 'float', 'bins': [-2.5, -2.4, -2.3, -2.2, -2.1, -2.0, -1.80, -1.566, -1.4442, -1.1, -0.8, -0.4, 0.0, 0.4, 0.8, 1.1, 1.4442, 1.566, 1.80, 2.0, 2.1, 2.2, 2.3, 2.4, 2.5], 'title':'#eta' },
...
bin2012_Ele35 = [
    { 'var' : 'probe_eta' , 'type': 'float', 'bins': [-2.5, -2.4, -2.3, -2.2, -2.1, -2.0, -1.80, -1.566, -1.4442, -1.1, -0.8, -0.4, 0.0, 0.4, 0.8, 1.1, 1.4442, 1.566, 1.80, 2.0, 2.1, 2.2, 2.3, 2.4, 2.5], 'title':'#eta' },

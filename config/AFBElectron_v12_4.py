...
############## binning ################
bin_ID = [
    { 'var' : 'el_eta' , 'type': 'float', 'bins': [-2.5, 2.5], 'title':'#eta' },
    { 'var' : 'el_pt' , 'type': 'float', 'bins': [100, 200, 300, 500, 1000, 3000], 'title':'p_{T} [GeV]' },
]
bin_Ele35 = [
    { 'var' : 'el_eta' , 'type': 'float', 'bins': [-2.5, 2.5], 'title':'#eta' },
    { 'var' : 'el_pt' , 'type': 'float', 'bins': [100, 200, 300, 500, 1000, 3000], 'title':'p_{T} [GeV]' },
...
bin2012_ID = [
    { 'var' : 'probe_eta' , 'type': 'float', 'bins': [-2.5, 2.5], 'title':'#eta' },
    { 'var' : 'probe_pt' , 'type': 'float', 'bins': [100, 200, 300, 500, 1000, 3000], 'title':'p_{T} [GeV]' },
]
bin2012_Ele35 = [
    { 'var' : 'probe_eta' , 'type': 'float', 'bins': [-2.5, 2.5], 'title':'#eta' },
    { 'var' : 'probe_pt' , 'type': 'float', 'bins': [100, 200, 300, 500, 1000, 3000], 'title':'p_{T} [GeV]' },

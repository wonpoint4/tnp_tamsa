...
############## binning ################
bin_ID = [
    { 'var' : 'el_eta' , 'type': 'float', 'bins': [-2.5, -2.4, -2.3, -2.2, -2.1, -1.80, -1.566, -1.4442, -1.1, -0.8, -0.4, 0.0, 0.4, 0.8, 1.1, 1.4442, 1.566, 1.80, 2.1, 2.2, 2.3, 2.4, 2.5], 'title':'#eta' },
...
bin2012_ID = [
    { 'var' : 'probe_eta' , 'type': 'float', 'bins': [-2.5, -2.4, -2.3, -2.2, -2.1, -1.80, -1.566, -1.4442, -1.1, -0.8, -0.4, 0.0, 0.4, 0.8, 1.1, 1.4442, 1.566, 1.80, 2.1, 2.2, 2.3, 2.4, 2.5], 'title':'#eta' },
...
config=tnpConfig(
    ...
    systematic=[
        ...
        [{'title':'nogenmatching','sim_genmatching':"(1)"}],
        [{'title':'old','sim_weight':"weight*PUweight"}],
        [{'title':'noprefireweight','sim_weight':"weight*PUweight*zptweight*z0weight"}],
        [{'title':'nozptweight','sim_weight':"weight*PUweight*prefireweight*z0weight"}],
        [{'title':'noz0weight','sim_weight':"weight*PUweight*prefireweight*zptweight"}],
    ],
    option="fix_ptbelow20",
)
Configs['2016a_MediumID_Plus']=config.clone(test='passingCutBasedMedium94XV2')
Configs['2016a_SelQ_MediumID_Plus']=config.clone(expr='( passingCutBasedMedium94XV2 && tag_passHltEle27WPTightGsf&&tag_passingCutBasedTight94XV2 && tag_Ele_pt>30 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',test='el_3charge')

## trigger
config=config.clone(
    tree='tnpEleTrig/fitter_tree',
    expr='( passingCutBasedMedium94XV2 && tag_passHltEle27WPTightGsf&&tag_passingCutBasedTight94XV2 && tag_Ele_pt>30 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',
    method="count",
    count_range=(76,106),
)
...
Configs['2016a_Ele27_SelQ_MediumID_Plus']=config.clone(
    bins=bin_Ele27,
    expr='( passingCutBasedMedium94XV2&&el_3charge && tag_passHltEle27WPTightGsf&&tag_passingCutBasedTight94XV2 && tag_Ele_pt>30 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',
    test='passHltEle27WPTightGsf',
)
...
Configs['2017_SelQ_MediumID_Plus']=config.clone(expr='( passingCutBasedMedium94XV2 && tag_passHltEle32DoubleEGWPTightGsf&&tag_passEGL1SingleEGOr&&tag_passingCutBasedTight94XV2 && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',test='el_3charge')

## trigger
config=config.clone(
    tree='tnpEleTrig/fitter_tree',
    expr='( passingCutBasedMedium94XV2 && tag_passHltEle32DoubleEGWPTightGsf&&tag_passEGL1SingleEGOr&&tag_passingCutBasedTight94XV2 && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',
    method="count",
    count_range=(76,106),
)
...
Configs['2017_Ele27_MediumID_Plus']=config.clone(
    bins=bin_Ele27,
    expr='( passingCutBasedMedium94XV2 && tag_passHltEle27WPTightGsf&&tag_passingCutBasedTight94XV2 && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',
    test='passHltEle27WPTightGsf',
)
Configs['2017_Ele32_MediumID_Plus']=config.clone(
    bins=bin_Ele32,
    expr='( passingCutBasedMedium94XV2 && tag_passHltEle32WPTightGsf&&tag_passingCutBasedTight94XV2 && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',
    test='passHltEle32WPTightGsf',
)
Configs['2017_Ele32DoubleEG_SelQ_MediumID_Plus']=config.clone(
    bins=bin_Ele32,
    expr='( passingCutBasedMedium94XV2&&el_3charge && tag_passHltEle32DoubleEGWPTightGsf&&tag_passEGL1SingleEGOr&&tag_passingCutBasedTight94XV2 && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',
    test='passHltEle32DoubleEGWPTightGsf&&passEGL1SingleEGOr',
)
Configs['2017_Ele27_SelQ_MediumID_Plus']=config.clone(
    bins=bin_Ele27,
    expr='( passingCutBasedMedium94XV2&&el_3charge && tag_passHltEle27WPTightGsf&&tag_passingCutBasedTight94XV2 && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',
    test='passHltEle27WPTightGsf',
)
Configs['2017_Ele32_SelQ_MediumID_Plus']=config.clone(
    bins=bin_Ele32,
    expr='( passingCutBasedMedium94XV2&&el_3charge && tag_passHltEle32WPTightGsf&&tag_passingCutBasedTight94XV2 && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',
    test='passHltEle32WPTightGsf',
)
...
Configs['2018_SelQ_MediumID_Plus']=config.clone(expr='( passingCutBasedMedium94XV2 && tag_passHltEle32WPTightGsf&&tag_passingCutBasedTight94XV2 && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',test='el_3charge')
...
Configs['2018_Ele28_MediumID_Plus']=config.clone(
    bins=bin_Ele28,
    expr='( passingCutBasedMedium94XV2 && tag_passHltEle28WPTightGsf&&tag_passingCutBasedTight94XV2 && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',

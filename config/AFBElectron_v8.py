...
Configs['2018_Ele28_SelQ_MediumID_Plus']=config.clone(
    bins=bin_Ele28,
    expr='( passingCutBasedMedium94XV2&&el_3charge && tag_passHltEle28WPTightGsf&&tag_passingCutBasedTight94XV2 && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',
    test='passHltEle28WPTightGsf',
)

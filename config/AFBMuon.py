...
samples={
    'data2016a':muondir+'TnPTreeZ_21Feb2020_UL2016_HIPM_SingleMuon_MiniAOD_Run2016Bver2CDEFv1.root',
    'mi2016a':muondir+'TnPTreeZ_106XSummer20_UL16MiniAODAPV_DYJetsToMuMu_M50_powhegMiNNLO_v2.root',
    'mg2016a':muondir+'TnPTreeZ_106XSummer20_UL16MiniAODAPV_DYJetsToLL_M50_MadgraphMLM_v1.root',
    'data2016b':muondir+'TnPTreeZ_21Feb2020_UL2016_SingleMuon_MiniAOD_Run2016FGHv1.root',
    'mi2016b':muondir+'TnPTreeZ_106XSummer20_UL16MiniAOD_DYJetsToMuMu_M50_powhegMiNNLO_v2.root',
    'mg2016b':muondir+'TnPTreeZ_106XSummer20_UL16MiniAOD_DYJetsToLL_M50_MadgraphMLM_v2.root',
    'data2017':muondir+'TnPTreeZ_09Aug2019_UL2017_SingleMuon_Run2017BCDEFv1.root',
    'mi2017':muondir+'TnPTreeZ_106XSummer20_UL17MiniAOD_DYJetsToMuMu_M50_massWgtFix_powhegMiNNLO_v2.root',
    'mg2017':muondir+'TnPTreeZ_106XSummer20_UL17MiniAOD_DYJetsToLL_M50_MadgraphMLM_v1.root',
    'data2018':muondir+'TnPTreeZ_12Nov2019_UL2018_SingleMuon_Run2018ABCv3_Dv8.root',
    'mi2018':muondir+'TnPTreeZ_106XSummer20_UL18MiniAOD_DYJetsToMuMu_M50_massWgtFix_powhegMiNNLO_v2.root',
    'mg2018':muondir+'TnPTreeZ_106XSummer20_UL18MiniAOD_DYJetsToLL_M50_MadgraphMLM_v1.root',
}
############## binning ################
binnings={
    'Mu8':[              ### For ID or Mu8

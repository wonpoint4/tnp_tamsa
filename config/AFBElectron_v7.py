...
### finer pt bins for HLT with counting method, add charge-inclusive result
############## samples ################
samples={
...
Configs['2016a_SelQ_MediumID_Plus']=config.clone(expr='( passingCutBasedMedium94XV2 && tag_Ele_pt>30 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',test='el_3charge')
...
Configs['2016a_Ele27_SelQ_MediumID_Plus']=config.clone(
    bins=bin_Ele27,
    expr='( passingCutBasedMedium94XV2&&el_3charge && tag_Ele_pt>30 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',
    test='passHltEle27WPTightGsf',
)
...
Configs['2017_SelQ_MediumID_Plus']=config.clone(expr='( passingCutBasedMedium94XV2 && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',test='el_3charge')
...
Configs['2017_Ele32DoubleEG_SelQ_MediumID_Plus']=config.clone(
    bins=bin_Ele32,
    expr='( passingCutBasedMedium94XV2&&el_3charge && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',
    test='passHltEle32DoubleEGWPTightGsf&&passEGL1SingleEGOr',
)
Configs['2017_Ele27_SelQ_MediumID_Plus']=config.clone(
    bins=bin_Ele27,
    expr='( PrescaleHLTEle27WPTightGsf && passingCutBasedMedium94XV2&&el_3charge && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',
    test='passHltEle27WPTightGsf',
)
Configs['2017_Ele32_SelQ_MediumID_Plus']=config.clone(
    bins=bin_Ele32,
    expr='( PrescaleHLTEle32WPTightGsf && passingCutBasedMedium94XV2&&el_3charge && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',
    test='passHltEle32WPTightGsf',
)
...
Configs['2018_SelQ_MediumID_Plus']=config.clone(expr='( passingCutBasedMedium94XV2 && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',test='el_3charge')
...
Configs['2018_Ele28_SelQ_MediumID_Plus']=config.clone(
    bins=bin_Ele28,
    expr='( PrescaleHLTEle28WPTightGsf && passingCutBasedMedium94XV2&&el_3charge && tag_Ele_pt>35 && el_q>0 )*(el_q*tag_Ele_q<0?1.:-1.)',
    test='passHltEle28WPTightGsf',
)
